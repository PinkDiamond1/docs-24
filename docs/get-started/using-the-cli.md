...
The [Kurtosis CLI](/install) is the main way you will interact with Kurtosis. This document will walk you through some common CLI workflows.
...
**TIP:** Kurtosis supports tab-completion. To add it, [follow these instructions](/cli#adding-tab-completion).
